...
import bletch.tektopiatinker.TektopiaTinker;
...
public class LoggerUtils {
    ...
    private static final File debugFile = new File(TektopiaTinker.proxy.getMinecraftDirectory() + ModDetails.FILE_DEBUGLOG);
