...
public class EntityAITinkerPatrolPoint extends EntityAIPatrolPoint {
	protected final EntityVillagerTek entity;
	protected VillageStructure structure;

	public EntityAITinkerPatrolPoint(EntityVillagerTek entity, Predicate<EntityVillagerTek> shouldPred, int distanceFromPoint, int waitTime) {
